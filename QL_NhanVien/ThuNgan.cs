...
{
    internal class ThuNgan : NhanVien
    {
        ...
        public ThuNgan(string MaNV, string Hoten, DateTime NgaySinh, string GioiTinh, string DiaChi, string SDT, double LuongCB, string HocVan) : base(MaNV, Hoten, NgaySinh, GioiTinh, DiaChi, SDT, LuongCB,HocVan)
        {
