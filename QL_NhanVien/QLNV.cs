...
namespace QL_NhanVien
{
    internal class QLNV
    {
        ...
        public void XoaNv(ref int choice)
        {
            ...
            for(int i = 0; i < m_index.Count; i++)
            {
                if (string.Compare(m_index[i].MaNV1, name) == 0)
                {
                    m_index.Remove(m_index[i]);
                }
            }
        }
        public void SuaNv(ref int choice)
        {
            string code = "";
            int index = 0;
            int chon = 0;
            ...
            for(int i = 0; i < m_index.Count; i++)
            {
                if (string.Compare(m_index[i].MaNV1, code) == 0)
                {
                    index = i;
                }
            }
            do
            {
                ...
                Console.WriteLine("\t\t\t*             1. Họ và tên                          *");
                Console.WriteLine("\t\t\t*             2. Ngày sinh                          *");
                Console.WriteLine("\t\t\t*             3. Địa chỉ                            *");
                Console.WriteLine("\t\t\t*             4. Số điện thoại                      *");
                Console.WriteLine("\t\t\t*             5. Học vấn                            *");
                Console.WriteLine("\t\t\t*****************************************************");
                Console.Write("\t--->> Nhập chức năng : ");
                chon = Convert.ToInt32(Console.ReadLine());
                Console.WriteLine();
                switch (chon)
                {
                    case 1:
                        ...
                        if (NhanVien.eventString(name) == true)
                        {
                            m_index[index].HoTen1 = name;
                        }
                        break;
                    case 2:
                        Console.Write("Nhap ngay sinh moi: ");
                        m_index[index].NgaySinh1 = NhanVien.eventTime();
                        break;
                    case 3:
                        Console.Write("Nhap dia chi moi : ");
                        string add = Console.ReadLine();
                        if (NhanVien.eventString(add) == true)
                        {
                            m_index[index].DiaChi1 = add;
                        }
                        break;
                    case 4:
                        Console.Write("Nhap so dien thoai moi : ");
                        string sdt = Console.ReadLine();
                        if (NhanVien.KTSDT(sdt) == true)
                        {
                            m_index[index].SDT1 = sdt;
                        }
                        break;
                    case 5:
                        Console.Write("Nhap hoc van : ");
                        string hocvan = Console.ReadLine();
                        if (NhanVien.eventString(hocvan) == true)
                        {
                            m_index[index].HocVan1 = hocvan;
                        }
                        break;
                }
            } while (true);
